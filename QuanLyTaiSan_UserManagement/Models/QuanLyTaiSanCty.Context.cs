...
namespace QuanLyTaiSan_UserManagement.Models
{
    ...
    public partial class QuanLyTaiSanCtyEntities : DbContext
    {
        ...
        public virtual DbSet<DeviceSparePart> DeviceSpareParts { get; set; }
        public virtual DbSet<DeviceSparePartHistory> DeviceSparePartHistories { get; set; }
    
        public virtual int AddDevice(string deviceCode, string newCode, string deviceName, Nullable<int> typeOfDevice, Nullable<int> parentId, string configuration, Nullable<double> price, string purchaseContract, Nullable<System.DateTime> dateOfPurchase, Nullable<int> supplierId, Nullable<int> projectId, Nullable<System.DateTime> guarantee, string notes, Nullable<int> userId, Nullable<int> status, string deviceNameEnglish, string deviceModel, string deviceSeria, Nullable<System.DateTime> dateAdded)
        {
            ...
            var deviceNameEnglishParameter = deviceNameEnglish != null ?
                new ObjectParameter("DeviceNameEnglish", deviceNameEnglish) :
                new ObjectParameter("DeviceNameEnglish", typeof(string));
            ...
            var deviceSeriaParameter = deviceSeria != null ?
                new ObjectParameter("DeviceSeria", deviceSeria) :
                new ObjectParameter("DeviceSeria", typeof(string));
        ...
        public virtual int AddProject_(string projectSymbol, string projectName, Nullable<int> managerProject, string address, Nullable<System.DateTime> fromDate, Nullable<System.DateTime> toDate, Nullable<int> status, Nullable<int> typeProject, Nullable<int> parentId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddProject_", projectSymbolParameter, projectNameParameter, managerProjectParameter, addressParameter, fromDateParameter, toDateParameter, statusParameter, typeProjectParameter, parentIdParameter);
        }
        ...
        public virtual int AddScheduleTest(Nullable<int> deviceId, Nullable<System.DateTime> dateOfTest, Nullable<System.DateTime> nextDateOfTest, string categoryTest, Nullable<int> userTest, string notes, string companyTest, Nullable<int> cycleTest)
        {
            var deviceIdParameter = deviceId.HasValue ?
                new ObjectParameter("DeviceId", deviceId) :
                new ObjectParameter("DeviceId", typeof(int));
            ...
            var companyTestParameter = companyTest != null ?
                new ObjectParameter("CompanyTest", companyTest) :
                new ObjectParameter("CompanyTest", typeof(string));
    
            var cycleTestParameter = cycleTest.HasValue ?
                new ObjectParameter("CycleTest", cycleTest) :
                new ObjectParameter("CycleTest", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddScheduleTest", deviceIdParameter, dateOfTestParameter, nextDateOfTestParameter, categoryTestParameter, userTestParameter, notesParameter, companyTestParameter, cycleTestParameter);
        }
        ...
        public virtual int UpdateDevice(Nullable<int> id, string deviceCode, string newCode, string deviceName, Nullable<int> typeOfDevice, Nullable<int> parentId, string configuration, Nullable<double> price, string purchaseContract, Nullable<System.DateTime> dateOfPurchase, Nullable<int> supplierId, Nullable<System.DateTime> guarantee, Nullable<int> userId, string notes, Nullable<System.DateTime> createdDate, Nullable<int> status, string deviceNameEnglish, string deviceModel, string deviceSeria, Nullable<System.DateTime> dateAdded)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateDevice", idParameter, deviceCodeParameter, newCodeParameter, deviceNameParameter, typeOfDeviceParameter, parentIdParameter, configurationParameter, priceParameter, purchaseContractParameter, dateOfPurchaseParameter, supplierIdParameter, guaranteeParameter, userIdParameter, notesParameter, createdDateParameter, statusParameter, deviceNameEnglishParameter, deviceModelParameter, deviceSeriaParameter, dateAddedParameter);
        }
        ...
        public virtual int UpdateProject(Nullable<int> id, string projectSymbol, string projectName, Nullable<int> managerProject, string address, Nullable<System.DateTime> fromDate, Nullable<System.DateTime> toDate, Nullable<System.DateTime> createdDate, Nullable<System.DateTime> modifiedDate, Nullable<int> status, Nullable<bool> isDeleted, Nullable<int> parentId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateProject", idParameter, projectSymbolParameter, projectNameParameter, managerProjectParameter, addressParameter, fromDateParameter, toDateParameter, createdDateParameter, modifiedDateParameter, statusParameter, isDeletedParameter, parentIdParameter);
        }
        ...
        public virtual int UpdateScheduleTest(Nullable<int> id, Nullable<int> deviceId, Nullable<System.DateTime> dateOfTest, Nullable<System.DateTime> nextDateOfTest, string categoryTest, Nullable<int> userTest, string notes, Nullable<int> status, string companyTest)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateScheduleTest", idParameter, deviceIdParameter, dateOfTestParameter, nextDateOfTestParameter, categoryTestParameter, userTestParameter, notesParameter, statusParameter, companyTestParameter);
        }
        ...
        public virtual ObjectResult<SearchRepairDetails_Result> SearchRepairDetails(Nullable<int> repairtypes, Nullable<int> user, Nullable<int> iddevice, Nullable<int> status, Nullable<int> departmentId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchRepairDetails_Result>("SearchRepairDetails", repairtypesParameter, userParameter, iddeviceParameter, statusParameter, departmentIdParameter);
        }
        ...
        public virtual ObjectResult<SearchScheduleTest_Result> SearchScheduleTest(Nullable<int> user, Nullable<int> status, Nullable<int> status_tt, Nullable<int> device_id)
        {
            var userParameter = user.HasValue ?
                new ObjectParameter("user", user) :
                new ObjectParameter("user", typeof(int));
            ...
            var status_ttParameter = status_tt.HasValue ?
                new ObjectParameter("Status_tt", status_tt) :
                new ObjectParameter("Status_tt", typeof(int));
    
            var device_idParameter = device_id.HasValue ?
                new ObjectParameter("Device_id", device_id) :
                new ObjectParameter("Device_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchScheduleTest_Result>("SearchScheduleTest", userParameter, statusParameter, status_ttParameter, device_idParameter);
        }
        ...
        public virtual ObjectResult<StatisticalDevice_Result> StatisticalDevice(Nullable<int> departmentId)
        {
            var departmentIdParameter = departmentId.HasValue ?
                new ObjectParameter("departmentId", departmentId) :
                new ObjectParameter("departmentId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<StatisticalDevice_Result>("StatisticalDevice", departmentIdParameter);
        }
    
        public virtual ObjectResult<StatisticProject_Result> StatisticProject(Nullable<int> departmentId)
        {
            var departmentIdParameter = departmentId.HasValue ?
                new ObjectParameter("departmentId", departmentId) :
                new ObjectParameter("departmentId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<StatisticProject_Result>("StatisticProject", departmentIdParameter);
        }
        ...
        public virtual int AddDeviceFiles(Nullable<int> deviceId, string deviceCode, string fileNames, string fileSize, string fileContent, string fileType, string fileLocal)
        {
            var deviceIdParameter = deviceId.HasValue ?
                new ObjectParameter("DeviceId", deviceId) :
                new ObjectParameter("DeviceId", typeof(int));
            ...
            var fileLocalParameter = fileLocal != null ?
                new ObjectParameter("FileLocal", fileLocal) :
                new ObjectParameter("FileLocal", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddDeviceFiles", deviceIdParameter, deviceCodeParameter, fileNamesParameter, fileSizeParameter, fileContentParameter, fileTypeParameter, fileLocalParameter);
        }
    
        public virtual int DeleteDeviceFiles(Nullable<int> file_id, string device_code)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteDeviceFiles", file_idParameter, device_codeParameter);
        }
    
        public virtual ObjectResult<SearchDeviceSparePart_Result> SearchDeviceSparePart(Nullable<int> deviceType, string sparePartName)
        {
            ...
            var sparePartNameParameter = sparePartName != null ?
                new ObjectParameter("SparePartName", sparePartName) :
                new ObjectParameter("SparePartName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchDeviceSparePart_Result>("SearchDeviceSparePart", deviceTypeParameter, sparePartNameParameter);
        }
    
        public virtual int AddSparePart(Nullable<int> deviceType, string sparePartCode, string sparePartName, Nullable<decimal> amount, Nullable<int> totalSparePart, Nullable<System.DateTime> dateAdded, string config, string notes)
        {
            var deviceTypeParameter = deviceType.HasValue ?
                new ObjectParameter("DeviceType", deviceType) :
                new ObjectParameter("DeviceType", typeof(int));
    
            var sparePartCodeParameter = sparePartCode != null ?
                new ObjectParameter("SparePartCode", sparePartCode) :
                new ObjectParameter("SparePartCode", typeof(string));
            ...
            var totalSparePartParameter = totalSparePart.HasValue ?
                new ObjectParameter("TotalSparePart", totalSparePart) :
                new ObjectParameter("TotalSparePart", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddSparePart", deviceTypeParameter, sparePartCodeParameter, sparePartNameParameter, amountParameter, totalSparePartParameter, dateAddedParameter, configParameter, notesParameter);
        }
    
        public virtual int DeleteDeviceSparePart(string id)
        {
            var idParameter = id != null ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteDeviceSparePart", idParameter);
        }
    
        public virtual int UpdateSparePart(Nullable<int> id, Nullable<int> deviceType, string sparePartName, Nullable<decimal> amount, Nullable<int> totalSparePart, Nullable<System.DateTime> dateAdded, string config, string notes)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateSparePart", idParameter, deviceTypeParameter, sparePartNameParameter, amountParameter, totalSparePartParameter, dateAddedParameter, configParameter, notesParameter);
        }
    
        public virtual int NhapDeviceSparePart(Nullable<int> sparePartId, Nullable<decimal> amount, Nullable<int> numSparePart, Nullable<System.DateTime> dateAdded, string notes)
        {
            var sparePartIdParameter = sparePartId.HasValue ?
                new ObjectParameter("SparePartId", sparePartId) :
                new ObjectParameter("SparePartId", typeof(int));
    
            var amountParameter = amount.HasValue ?
                new ObjectParameter("Amount", amount) :
                new ObjectParameter("Amount", typeof(decimal));
    
            var numSparePartParameter = numSparePart.HasValue ?
                new ObjectParameter("NumSparePart", numSparePart) :
                new ObjectParameter("NumSparePart", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("NhapDeviceSparePart", sparePartIdParameter, amountParameter, numSparePartParameter, dateAddedParameter, notesParameter);
        }
    
        public virtual int XuatDeviceSparePart(Nullable<int> sparePartId, Nullable<int> numSparePart, Nullable<System.DateTime> dateAdded, string notes)
        {
            var sparePartIdParameter = sparePartId.HasValue ?
                new ObjectParameter("SparePartId", sparePartId) :
                new ObjectParameter("SparePartId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("XuatDeviceSparePart", sparePartIdParameter, numSparePartParameter, dateAddedParameter, notesParameter);
        }
    
        public virtual ObjectResult<SearchDeviceSparePartHistory_Result> SearchDeviceSparePartHistory(Nullable<int> deviceType, string sparePartName, string typeTran)
        {
            var deviceTypeParameter = deviceType.HasValue ?
                new ObjectParameter("DeviceType", deviceType) :
                new ObjectParameter("DeviceType", typeof(int));
            ...
            var typeTranParameter = typeTran != null ?
                new ObjectParameter("TypeTran", typeTran) :
                new ObjectParameter("TypeTran", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchDeviceSparePartHistory_Result>("SearchDeviceSparePartHistory", deviceTypeParameter, sparePartNameParameter, typeTranParameter);
        }
    
        public virtual int DeleteDeviceSparePartHistory(string id)
        {
            var idParameter = id != null ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteDeviceSparePartHistory", idParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> GetMaxIdSparePart()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("GetMaxIdSparePart");
        }
    
        public virtual ObjectResult<GetData_PieChart_Result> GetData_PieChart()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetData_PieChart_Result>("GetData_PieChart");
        }
    
        public virtual ObjectResult<GetData_HorizontalChart_Result> GetData_HorizontalChart()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetData_HorizontalChart_Result>("GetData_HorizontalChart");
        }
    
        public virtual int SearchDepartment(Nullable<int> managerProject, Nullable<int> status, Nullable<int> typeProject, string projectSymbol, Nullable<int> hasChild, Nullable<int> parentId, Nullable<int> departmentId)
        {
            var managerProjectParameter = managerProject.HasValue ?
                new ObjectParameter("managerProject", managerProject) :
                new ObjectParameter("managerProject", typeof(int));
            ...
            var hasChildParameter = hasChild.HasValue ?
                new ObjectParameter("HasChild", hasChild) :
                new ObjectParameter("HasChild", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SearchDepartment", managerProjectParameter, statusParameter, typeProjectParameter, projectSymbolParameter, hasChildParameter, parentIdParameter, departmentIdParameter);
        }
        ...
        public virtual ObjectResult<SearchProject_Result> SearchDepartStage(Nullable<int> managerProject, Nullable<int> status, Nullable<int> typeProject, string projectSymbol, Nullable<int> hasChild, Nullable<int> parentId, Nullable<int> departmentId)
        {
            var managerProjectParameter = managerProject.HasValue ?
                new ObjectParameter("managerProject", managerProject) :
                new ObjectParameter("managerProject", typeof(int));
