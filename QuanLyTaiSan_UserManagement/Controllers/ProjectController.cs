...
namespace QuanLyTaiSan_UserManagement.Controllers
{
    ...
    public class ProjectController : Controller
    {
        ...
        public ActionResult AddProject(FormCollection colection, ProjectDKC Project)
        {
            ...
            {
                Ql.AddProject_(ProjectSymbol, ProjectName, ManagerProject, Address, FromDate, ToDate, Status, null, null);
        ...
        public ActionResult EditProject(FormCollection colection, ProjectDKC Project)
        {
            ...
            Ql.UpdateProject(Id, ProjectSymbol, ProjectName, ManagerProject, Address, FromDate, ToDate, CreatedDate, ModifiedDate, Status, IsDeleted, null);
       ...
       public string Get_Status(int? status) {
        ...
        public JsonResult ExportToExcel(int? IdProject)
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                using (System.Web.UI.HtmlTextWriter htw = new System.Web.UI.HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment; filename=PhongBanDetails_" + strDateFormat + ".xlxs");
        ...
        public JsonResult GetDeviceInProjectMachine(string dvc)
        {
            ...
            Ql.Configuration.ProxyCreationEnabled = false;
            bool Result = false;
            if (Ql.SearchDevice(null, null, null, null, null, session.UserName).Where(x => x.DeviceCode.Trim() == dvc).Count() == 1)
            {
